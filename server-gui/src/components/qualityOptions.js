...
export function getVideoQualityOptions(options) {
    ...
    if (maxAllowedWidth >= 3800 && hostScreenWidth >= 1930) {
        qualityOptions.push({ name: '4K', maxHeight: 2160, bitrate: 120000000 });
        // qualityOptions.push({ name: '4K - 80 Mbps', maxHeight: 2160, bitrate: 80000000 });
    }
    // Some 1080- videos are reported as 1912?
    if (maxAllowedWidth >= 1900 && hostScreenWidth >= 1290) {
        qualityOptions.push({ name: '1080p', maxHeight: 1080, bitrate: 60000000 });
    ...
    if (maxAllowedWidth >= 1260 && hostScreenWidth >= 650) {
        qualityOptions.push({ name: '720p', maxHeight: 720, bitrate: 4000000 });
    ...
    if (maxAllowedWidth >= 620) {
        qualityOptions.push({ name: '480p', maxHeight: 480, bitrate: 720000 });
    ...
    qualityOptions.push({ name: '360p', maxHeight: 360, bitrate: 420000 });
